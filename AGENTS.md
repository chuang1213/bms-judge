...
**当前最优 = `B_resp+dev` + MSD 轴（180d 半衰期）：acc **5.914** / cR² +0.463 / lamp 1.091（QWK 0.750）/ BP 111.1**
**（样本空间已扩围：2026-09-11 纳入 normal☆ 表，13,446 行 = train 6,719 / test 6,727；与旧空间
的 5.887/12,725 行**不可直接比较**——旧空间同配置为 5.887，MSD 增益在新空间 +0.259 p=4e-15）**
