...
**当前最优 = `B_resp` + 半衰期 180d：acc **6.360** / cR² +0.443 / lamp 1.197（QWK 0.715）/ BP 122.1**
（= v1 27 + 手工历史 12 + **acc 响应块 24** + **lamp 响应块(仅 chart-conditioned 13)** + **BP 响应块**；
等权版本 acc 6.495 / cR² +0.438 / lamp 1.222 —— 遗忘带来 **+0.136**（配对 6,367 行：
95% CI 0.071..0.195、p=2e-5、52.7% 样本改善）。复现见 `response_decay.py`；
